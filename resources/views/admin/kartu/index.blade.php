      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('admin/kartu/store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-2">
                <input type="text" class="form-control" name="kode" id="exampleInputEmail1" 
                aria-describedby="emailHelp" placeholder="Input Kode">
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
                <input type="text" class="form-control" name="diskon" id="exampleInputEmail1" 
                aria-describedby="emailHelp" placeholder="Input Diskon">
                </div>
            <div class="mb-2">
                <input type="text" class="form-control" name="iuran" id="exampleInputEmail1" 
                aria-describedby="emailHelp" placeholder="Input iuran">
            </div>
        </div>
